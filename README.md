<html>
    <head>
        <title>ameenshas</title>
        <link rel="stylesheet" href="lastchallage.css">
        ...
        <div class="main-container">
            <div class="left">
                <div class="top">
                    <div class="first new">
                        <!--svg-->
                        <img src="./images/bg-pattern-quotation.svg" alt="avg" id="quete">
                ...
                <div class="bottom">
                    ...
                    <div class="fourth new"><div class="header">
